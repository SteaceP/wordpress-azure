...
- Current WordPress version: 6.4.1 [(official zip)](https://wordpress.org/wordpress-6.4.1.zip)
- PHP 8.2.13 version is being used for WordPress on the Azure Marketplace.
